...
interface EditDishModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (dish: FoodItem) => void;
  dish: FoodItem | null;
}

export const EditDishModal = ({ isOpen, onClose, onSave, dish }: EditDishModalProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.price || !formData.description || !dish) {
      toast({
